Kh69coin Core version 0.13.3 is now available from:

  <https://download.kh69coin.org/kh69coin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/kh69coin-project/kh69coin/blob/0.13/src/chainparams.cpp#L214).

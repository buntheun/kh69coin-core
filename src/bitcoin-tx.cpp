...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s kh69coin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  kh69coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded kh69coin transaction") + "\n" +
              "  kh69coin-tx [options] -create [commands]   " + _("Create hex-encoded kh69coin transaction") + "\n" +
              "\n";

...
const char * const BITCOIN_CONF_FILENAME = "kh69coin.conf";
const char * const BITCOIN_PID_FILENAME = "kh69coind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Kh69coin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Kh69coin";
#else
    // Unix
    return pathRet / ".kh69coin";
#endif
#endif
}
